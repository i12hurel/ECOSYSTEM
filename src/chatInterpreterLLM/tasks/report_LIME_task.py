...
def return_task_report_LIME(metadata):
    task_report_LIME = Task(
        ...
        **Instructions:**
        ...
        5. **Critically evaluate the coherence between the model's explanation and the user's input.**
        ...
        6. Write the final report in a clear and structured way, balancing objective analysis with contextual understanding.
